...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/content/coco_format_v2/fold0/train.json',
        ...
        classes=('Atelectasis', 'Calcification', 'Cardiomegaly',
                 'Consolidation', 'Diffuse Nodule', 'Effusion', 'Emphysema',
                 'Fibrosis', 'Fracture', 'Mass', 'Nodule',
                 'Pleural Thickening', 'Pneumothorax')),
    val=dict(
        type='CocoDataset',
        ann_file='/content/coco_format_v2/fold0/valid.json',
        img_prefix='/content/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file='/content/coco_format_v2/test.json',
...
log_level = 'INFO'
load_from = '/content/mask_rcnn_r50_fpn_dconv_c3-c5_1x_coco_20200203-4d9ad43b.pth'
resume_from = None
workflow = [('train', 1)]
